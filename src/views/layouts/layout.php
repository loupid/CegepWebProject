...
<div class="flex flex-col justify-between">
    ...
    <footer class="bg-white bottom-0 border-t-2 dark:bg-gray-800">
        <div class="container mx-auto px-6 py-4">
                ...
                <div class="mt-6 lg:mt-0 lg:flex-1">
                    <div class="grid gap-2 grid-cols-1 sm:grid-cols-1 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <a href="tel:819-376-1721p3706" class="block mt-2 text-sm text-gray-600 dark:text-gray-400">819
            ...
            <div>
                <p class="text-center text-gray-800 dark:text-white">Tous droits réservés - © Département d'informatique
                    du
