    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
        ...
        <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
            ...
            <nav x-data="{ selecteditem: '<?= $selectedItem; ?>' }" class="mt-10">
                ...
                <a :class=" selecteditem === 'tutorat' ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100' "
                   @click="selecteditem = 'tutorat'" class="flex items-center mt-4 py-2 px-6"
                   href="<?= $this->router->generate('tutorattable'); ?>">
                    <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                         stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                ...
                <a :class=" selecteditem === 'espace' ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100' "
                   @click="selecteditem = 'espace'" class="flex items-center mt-4 py-2 px-6"
                   href="<?= $this->router->generate('espaceIndex'); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span class="mx-3">Espace I</span>
                </a>
