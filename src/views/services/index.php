...
<!-- Espace I -->
<section id="espacei" class="h-full z-0">
    <div class="relative bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto">
            <div class="relative pb-8 bg-white sm:pb-16 md:pb-20 lg:w-full lg:pb-28 xl:pb-32 max-w-full">
    ...
    <div class="w-full m-1 mt-10 mx-auto rounded-lg bg-white shadow-lg px-5 pt-5 pb-10 text-gray-800"
        ...
        <div class="w-full">
            <p class="text-md font-bold text-center" style="color: #061f50;">Raphaël Céré</p>
                    ...
                    <div class="sm:text-center lg:text-right justify-end">
                        <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                            <span class="block xl:inline"
                                  style="color: #061f50;">Centre d’aide en informatique (Espace I)</span>
                        </h1>
                        <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0 lg:text-right">
    ...
    <form class="flex h-screen bg-gray-200 items-center justify-center" style="height:fit-content;"
        ...
        <div class="my-12 grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-5 md:gap-8 mt-5 mx-7">
                <div class="grid grid-cols-1">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold" for="prenom">Lundi</label>
                    <div>
                ...
                <div class="grid grid-cols-1">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold" for="prenom">Mardi</label>
                    <div>
                        <label class="inline-flex items-center">
                        <input type="checkbox" class="form-checkbox" checked>
                        <span class="ml-2">Disponible</span>
                ...
                <div class="grid grid-cols-1">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold" for="prenom">Mercredi</label>
                    <div>
                        <label class="inline-flex items-center">
                        <input type="checkbox" class="form-checkbox" checked>
                        <span class="ml-2">Disponible</span>
                ...
                <div class="grid grid-cols-1">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold" for="prenom">Jeudi</label>
                    <div>
                        <label class="inline-flex items-center">
                        <input type="checkbox" class="form-checkbox" checked>
                        <span class="ml-2">Disponible</span>
                ...
                <div class="grid grid-cols-1">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold" for="prenom">Vendredi</label>
                    <div>
                        <label class="inline-flex items-center">
                        <input type="checkbox" class="form-checkbox" checked>
                        <span class="ml-2">Disponible</span>
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-5 md:gap-8 mt-5 mx-7">
                <div class="grid grid-cols-1">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold" for="prenom">Début</label>
                    <div class="col-span-6 sm:col-span-3">
                        <input type="time" name="start_date" id="start_date" :min="new Date().toISOString().slice(0,-8)"
            ...
            <div class="grid grid-cols-3 md:grid-cols-5 gap-5 md:gap-8 mt-5 mx-7">
                <div class="grid grid-cols-1">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold" for="prenom">Fin</label>
                    <div class="col-span-6 sm:col-span-3">
                        <input type="time" name="start_date" id="start_date" :min="new Date().toISOString().slice(0,-8)"
                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
