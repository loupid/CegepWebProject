...
?>
    ...
    <div class="mt-10 sm:mt-0">
        <div class="mt-5 md:mt-0 md:col-span-2">
            <form id="Form" action="<?= $this->router->generate('offersCreated') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                                <label for="clothes_id" class="block text-sm font-medium text-gray-700">Vêtement</label>
                                <div x-data="select({ data : <?= $clothesJSON ?>, emptyOptionsMessage: 'Aucun donnée disponible.', name: 'clothes_id', placeholder: 'Sélectionnez un vêtement', value: ''})"
                                     x-init="init()"
                            ...
                            <div class="col-span-6 sm:col-span-3 lg:col-span-3">
                                ...
                                <input type="number" step="0.01" min="0" max="9999999999.99" name="price" id="price" autocomplete="price"
