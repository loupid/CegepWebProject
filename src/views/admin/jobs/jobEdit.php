...
<div class="mt-10 sm:mt-0">
    <div class="mt-5 md:mt-0 md:col-span-2">
        <form id="Form" action="<?= $this->router->generate('jobUpdated') ?>" method="POST"
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                            ...
                            <div x-data="select({ data : setJobCategorySelectBox(), emptyOptionsMessage: 'Aucun donnée disponible.', name: 'category', placeholder: 'Sélectionnez une catégorie', value: getJobKey('<?= $job->category ?>')})"
                                 x-init="init()"
                        ...
                        <div class="col-span-4 col-span-6 lg:col-span-2">
                            ...
                            <input type="text" name="employer" id="employer" value="<?= $job->employer ?>"
                                   class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                        <div class="col-span-4 col-span-6 lg:col-span-2">
                            <label for="city"
                        ...
                        <div class="col-span-4 col-span-6 lg:col-span-2">
                            <label for="salairy" class="block text-sm font-medium text-gray-700">Salaire</label>
                            <input type="number" step="0.01" min="0" max="9999999999.99" name="salairy" id="salairy"
                                   autocomplete="price" value="<?= $job->salairy ?>"
                                   class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                            ...
                            <input type="text" name="phone" id="phone" value="<?= $job->phone ?>"
                                   class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>

                        <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                            <label for="start" class="block text-sm font-medium text-gray-700">Début</label>
                            <input type="datetime-local" name="start" id="start" value="<?=date("Y-m-d\TH:i:s", strtotime($job->start)) ?>"
                        ...
                        <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                            ...
                            <input type="number" name="duration" id="duration" min="0" value="<?= $job->duration ?>"
                                   class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                            ...
                            <textarea name="description" id="description" rows="4" autocomplete="description"
                                      class="mt-1 p-1.5 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"><?= $job->description ?></textarea>
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                            ...
                            <textarea name="skills" id="skills" rows="4" autocomplete="description"
                                      class="mt-1 p-1.5 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"><?= $job->skills ?></textarea>
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-3 lg:col-span-3">
                            ...
                            <input type="checkbox" name="hide" id="hide" value="1"
                                   class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 w-5 h-5 shadow-sm sm:text-sm border-gray-300 rounded-md" <?= $job->hide ? 'checked':''?>>
                        </div>
                    </div>
                </div>
